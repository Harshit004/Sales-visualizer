...
import { prepareSalesRepData } from "@/lib/chart-data"

interface SalesRepPerformanceChartProps {
  data: SalesData[]
}

export function SalesRepPerformanceChart({ data }: SalesRepPerformanceChartProps) {
  ...
  useEffect(() => {
    ...
    const initChart = async () => {
      try {
        ...
        // Add data
        const chartData = prepareSalesRepData(data)
